...
<body>
    ...
    <div class="content-wrapper">
        <h1 class="text-center mt-5">Tambah Data Religion</h1>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="/insertdatareligion" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="exampleInputNama" class="form-label">Nama Agama</label>
                                ...
                                <a href="/datareligion" class="mt-4 kembali" style="float: right">Kembali</a>
                            </form>
                        </div>
                    </div>
                </div>
